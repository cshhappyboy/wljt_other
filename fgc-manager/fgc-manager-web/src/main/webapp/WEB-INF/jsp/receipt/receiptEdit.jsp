		...
		<form id="form" method="post">
			<table align="center">
				...
				<tr>
					...
					<td><input name="dbilldate" type= "text" class= "easyui-datebox" required ="required" data-options="editable:false" 
				...
				<tr>
					...
					<td><input name="total" class="easyui-numberbox" data-options="max:${receiptHVO.maxtotal},precision:0,required:true," 
				...
				<tr>
					...
					<td><input name="vsrcbilltype" class="easyui-combobox" data-options="readonly:true,required:true,valueField:'billtype_id',textField:'billtype_name',panelHeight:115,url:'${pageContext.request.contextPath}/billtype/30'"
