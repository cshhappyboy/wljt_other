		...
		<form id="form" method="post">
			<table class="table table-hover table-condensed">
				<tr>
					...
					<th>角色名称</th>
					<td><input name="name" value="${role.name}" type="text"
						placeholder="请输入角色名称" class="easyui-validatebox span2"
				...
				<input input id="ts" name="ts" value="${role.ts}"
					style="display: none" />
				<input input id="dr" name="dr" value="${role.dr}"
					style="display: none" />
			</table>
		</form>
	</div>
