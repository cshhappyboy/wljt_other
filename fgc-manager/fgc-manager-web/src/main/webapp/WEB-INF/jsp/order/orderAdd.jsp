		...
		<form id="form" method="post">
			<table align="center">
				...
				<tr>
					...
					<td><input name="cbilltype" class="easyui-combobox" data-options="editable:false,required:true,valueField:'billtype_id',textField:'billtype_name',panelHeight:115,url:'${pageContext.request.contextPath}/billtype/30'"
				...
				<tr>
					...
					<td><input name="nexchangerate" id="nexchangerate" class="easyui-numberbox" data-options="required:true,readonly:true,precision:2"
