							...
							options : {
								...
								onChange:function(newValue, oldValue){
									...
									if(srow.services && srow.services==1){
									    ...
									    delwarehouseED.target.textbox({readonly:true});
									}
									if(newValue){
		...
		<form id="form" method="post">
			<table align="center">
				...
				<tr>
					...
					<td><input name="cbilltype" class="easyui-combobox" data-options="readonly:true,required:true,valueField:'billtype_id',textField:'billtype_name',panelHeight:115,url:'${pageContext.request.contextPath}/billtype/30'"
