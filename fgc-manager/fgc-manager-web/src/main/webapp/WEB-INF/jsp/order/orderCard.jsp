		...
		<form id="form" method="post">
			<table align="center">
				...
				<tr>
					...
					<td><input name="vbillstatus" class="easyui-combobox"  data-options="readonly:true,valueField: 'key',textField: 'value', data: [{key: '0',value: '<spring:message code="free" />'},{key: '1',value: '<spring:message code="approved" />'},{key: '2',value: '作废'}],panelHeight:70" value="${orderHVO.vbillstatus}"></td>
