                ...
                editor : {
					...
					options : {
						...
						onChange:function(newValue,oldValue){
							...
							if(newValue && oldValue > 0 && $.MMNumberSub(newValue,oldValue)> 0){
							...
							var vtransrateED = finprodinBDataGrid.datagrid('getEditor', {
								index : rindex,
								field : 'vtransrate'
							});
							var measrate = vtransrateED.target.numberbox('getValue');
		...
		<form id="form" method="post">
			<table align="center">
				...
				<tr>
					...
					<td><input name="cbilltype" class="easyui-combobox" data-options="required:true,valueField:'billtype_id',textField:'billtype_name',panelHeight:25,url:'${pageContext.request.contextPath}/billtype/46'"
					...
					<td><input id="ntotalnum" name="ntotalnum"
						class="easyui-numberbox" data-options="precision:4"
