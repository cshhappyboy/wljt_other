...
<script type="text/javascript">
	$(function() {
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/param/updateParam',
			onSubmit : function() {
	...
	<div data-options="region:'center',fit: true, border: false">
		<form id="form" method="post">
			<table class="table table-hover table-condensed">
				<tr>
					<input name="id" value="${paramVO.id}" style="display: none">
				</tr>
				<tr>
					<th>编码</th>
					<td><input name="code" class="easyui-textbox"
						data-options="readonly:true" value="${paramVO.code}"></td>
					<th>名称</th>
					<td><input name="name" class="easyui-textbox"
						data-options="readonly:true" value="${paramVO.name}"></td>
				</tr>
				<tr>
					<th>值</th>
					<td><input name="value" class="easyui-textbox"
						data-options="required:true" value="${paramVO.value}"></td>
					<th></th>
					<td></td>
				</tr>
			</table>
