											...
											options : {
												...
												onChange:function(newValue,oldValue){
													if(newValue){
														...
														if(newValue && $.MMNumberSub(newValue,row.nshouldassistnum)> 0){
															var nassistnumED = saleOutBDataGrid.datagrid('getEditor', {
																index : rindex,
																field : 'nassistnum'
															});
															nassistnumED.target.numberbox('setValue',null);
															return;
														}
		...
		<form id="form" method="post">
			<table align="center">
				...
				<tr>
					...
					<td><input name="cbilltype" class="easyui-combobox" data-options="readonly:true,required:true,valueField:'billtype_id',textField:'billtype_name',panelHeight:75,url:'${pageContext.request.contextPath}/billtype/4C'"
					...
					<td><input id="ntotalnum" name="ntotalnum"
						class="easyui-numberbox" data-options="readonly:true,min:0,precision:4"
				...
				<tr>
					...
					<td><input id = "effectbillcode" name="effectbillcode" class="easyui-textbox" data-options="readonly:true,"
						 value="${saleOutHVO.effectbillcode}"></td>
					<th><spring:message code="vinvoicebillcode" /></th>
					<td><input id = "vinvoicebillcode" name="vinvoicebillcode" class="easyui-textbox" data-options="readonly:true,"
				...
				<tr>
					...
					<td><input id = "client" name="client" class="easyui-textbox" data-options="readonly:true,"
						 value="${saleOutHVO.client}"></td>
					<th><spring:message code="address" /></th>
					<td><input id = "address" name="address" class="easyui-textbox" data-options="readonly:true,"
				...
				<tr>
					<th>销售退回</th>
					<td><input  name="saletuihui" class="easyui-combobox" data-options="readonly:true,panelHeight:50,valueField: 'value',textField: 'text',value:0,data:[{'value':0,'text':'<spring:message code="no" />'},{'value':1,'text':'<spring:message code="yes" />'}]"
