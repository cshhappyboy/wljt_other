 ...
 */
@Service
public class WhstransPOIParams implements IPOIParams {
	...
	public String getExportSheetName() {
		return pubInfoService.getValueByCode("WHSTRANS_EXPORT_SHEET_NAME");
	}

	@Override
	public InputStream getTemplateInputStream() {
		return this.getClass().getClassLoader()
				.getResourceAsStream(EXCEL_ROOT_PATH + pubInfoService.getValueByCode("WHSTRANS_FILE_NAME"));
	}
