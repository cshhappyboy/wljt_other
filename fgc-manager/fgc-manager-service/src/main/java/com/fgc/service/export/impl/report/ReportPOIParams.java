 ...
 */
@Service
public class ReportPOIParams implements IPOIParams {
	...
	public String getExportSheetName() {
		return pubInfoService.getValueByCode("MONEYDETAIL_EXPORT_SHEET_NAME");
	}

	@Override
	public InputStream getTemplateInputStream() {
		return this.getClass().getClassLoader()
				.getResourceAsStream(EXCEL_ROOT_PATH + pubInfoService.getValueByCode("MONEYDETAIL_FILE_NAME"));
	}
