 ...
 */
@Service
public class InvoiceblPOIParams implements IPOIParams {
	...
	public String getExportSheetName() {
		return pubInfoService.getValueByCode("INVOICE_BL_EXPORT_SHEET_NAME");
	}

	@Override
	public InputStream getTemplateInputStream() {
		return this.getClass().getClassLoader()
				.getResourceAsStream(EXCEL_ROOT_PATH + pubInfoService.getValueByCode("INVOICE_BL_FILE_NAME"));
	}
