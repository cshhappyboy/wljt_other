...
public class CurrencyServiceImpl implements ICurrencyService {
	...
	@Value("${REST_QUERY_ALL_CURRENCY}")
	private String REST_QUERY_ALL_CURRENCY;

	@Value("${REST_QUERY_CURRENCY_ID}")
	private String REST_QUERY_CURRENCY_ID;
	...
	public String queryData(String filterData) throws Exception {
		...
		String strResult = HttpClientUtil
				.doPost(pubInfoService.getValueByCode("REST_BASE_URL") + REST_QUERY_ALL_CURRENCY, mapParam);
		return strResult;
	}
	...
	public String queryNameById(String id, String local) throws Exception {
		String strResult = HttpClientUtil
				.doGet(pubInfoService.getValueByCode("REST_BASE_URL") + REST_QUERY_CURRENCY_ID + id + "/" + local);
		return strResult;
	}
