...
public class OnhandNumVO {
    private String pkonhandnum;
    ...
    public void setPkonhandnum(String pkonhandnum) {
        this.pkonhandnum = pkonhandnum == null ? null : pkonhandnum.trim();
    }
    ...
    public BigDecimal getNonhandastnum() {
        return nonhandastnum;
    }

    public void setNonhandastnum(BigDecimal nonhandastnum) {
        this.nonhandastnum = nonhandastnum;
    }
