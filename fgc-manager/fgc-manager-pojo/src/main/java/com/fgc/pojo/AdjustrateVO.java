...
public class AdjustrateVO {
    ...
    public String getPkadjustrate() {
        return pkadjustrate;
    }

    public void setPkadjustrate(String pkadjustrate) {
        this.pkadjustrate = pkadjustrate == null ? null : pkadjustrate.trim();
    }
    ...
    public void setAdjustrate(String adjustrate) {
        this.adjustrate = adjustrate == null ? null : adjustrate.trim();
    }
    ...
    public String getPkaccperiod() {
        return pkaccperiod;
    }

    public void setPkaccperiod(String pkaccperiod) {
        this.pkaccperiod = pkaccperiod == null ? null : pkaccperiod.trim();
    }
}