...
public class CashAccountVO {
    ...
    private String pkmoneytype;

    public String getPkcashaccount() {
        return pkcashaccount;
    }

    public void setPkcashaccount(String pkcashaccount) {
        this.pkcashaccount = pkcashaccount == null ? null : pkcashaccount.trim();
    }
    ...
    public String getPkmoneytype() {
        return pkmoneytype;
    }

    public void setPkmoneytype(String pkmoneytype) {
        this.pkmoneytype = pkmoneytype == null ? null : pkmoneytype.trim();
    }
}