...
public class SaleOutHVO {

	private String dsigndatestart;

	private String dsigndateend;
	...
	private String vinvoicebillcode;

	private String vorderbillcode;

	private Long returnsale;

	private String vorderhid;

	private Long saletuihui;
	...
	public String getVinvoicebillcode() {
		return vinvoicebillcode;
	}

	public void setVinvoicebillcode(String vinvoicebillcode) {
		this.vinvoicebillcode = vinvoicebillcode == null ? null : vinvoicebillcode.trim();
	}
	...
	public String getVorderhid() {
		return vorderhid;
	}

	public void setVorderhid(String vorderhid) {
		this.vorderhid = vorderhid == null ? null : vorderhid.trim();
	}

	public Long getSaletuihui() {
		return saletuihui;
	}

	public void setSaletuihui(Long saletuihui) {
		this.saletuihui = saletuihui;
	}
	...
	/**
	 * @return the dsigndatestart
	 */
	public String getDsigndatestart() {
		return dsigndatestart;
	}

	/**
	 * @param dsigndatestart
	 *            the dsigndatestart to set
	 */
	public void setDsigndatestart(String dsigndatestart) {
		this.dsigndatestart = dsigndatestart;
	}

	/**
	 * @return the dsigndateend
	 */
	public String getDsigndateend() {
		return dsigndateend;
	}

	/**
	 * @param dsigndateend
	 *            the dsigndateend to set
	 */
	public void setDsigndateend(String dsigndateend) {
		this.dsigndateend = dsigndateend;
	}
