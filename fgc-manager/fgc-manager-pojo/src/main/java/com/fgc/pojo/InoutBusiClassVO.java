...
public class InoutBusiClassVO {
    private String pkinoutbusiclass;
    ...
    public String getPkinoutbusiclass() {
        return pkinoutbusiclass;
    }

    public void setPkinoutbusiclass(String pkinoutbusiclass) {
        this.pkinoutbusiclass = pkinoutbusiclass == null ? null : pkinoutbusiclass.trim();
    }
