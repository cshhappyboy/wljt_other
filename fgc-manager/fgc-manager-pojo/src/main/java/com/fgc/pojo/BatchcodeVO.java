...
public class BatchcodeVO {
    ...
    public void setPkbatchcode(String pkbatchcode) {
        this.pkbatchcode = pkbatchcode == null ? null : pkbatchcode.trim();
    }
    ...
    public void setDproducedate(String dproducedate) {
        this.dproducedate = dproducedate == null ? null : dproducedate.trim();
    }
    ...
    public void setDvalidate(String dvalidate) {
        this.dvalidate = dvalidate == null ? null : dvalidate.trim();
    }

    public String getDinbounddate() {
        return dinbounddate;
    }

    public void setDinbounddate(String dinbounddate) {
        this.dinbounddate = dinbounddate == null ? null : dinbounddate.trim();
    }
}