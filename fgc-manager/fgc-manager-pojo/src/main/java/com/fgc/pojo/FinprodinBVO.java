...
public class FinprodinBVO {
    ...
    private String vtransrate;

    private BigDecimal ninassistnum;

    private BigDecimal ninnum;

    private String dbizindate;

    private String momen;
    ...
    private BigDecimal costunitmny;
    ...
    public String getVrownum() {
        return vrownum;
    }

    public void setVrownum(String vrownum) {
        this.vrownum = vrownum == null ? null : vrownum.trim();
    }
    ...
    public String getVtransrate() {
        return vtransrate;
    }

    public void setVtransrate(String vtransrate) {
        this.vtransrate = vtransrate == null ? null : vtransrate.trim();
    }

    public BigDecimal getNinassistnum() {
        return ninassistnum;
    }

    public void setNinassistnum(BigDecimal ninassistnum) {
    ...
    public String getDbizindate() {
        return dbizindate;
    }

    public void setDbizindate(String dbizindate) {
        this.dbizindate = dbizindate == null ? null : dbizindate.trim();
    }
    ...
    public void setMomen(String momen) {
        this.momen = momen == null ? null : momen.trim();
    }
    ...
    public void setVsrcbid(String vsrcbid) {
        this.vsrcbid = vsrcbid == null ? null : vsrcbid.trim();
    }
    ...
    public BigDecimal getCostunitmny() {
        return costunitmny;
    }

    public void setCostunitmny(BigDecimal costunitmny) {
        this.costunitmny = costunitmny;
    }
