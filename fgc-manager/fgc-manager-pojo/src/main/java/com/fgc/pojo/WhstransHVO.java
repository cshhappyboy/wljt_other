...
public class WhstransHVO {
	...
	private String coutwarehouseid;
	...
	public void setCotherwhid(String cotherwhid) {
		this.cotherwhid = cotherwhid == null ? null : cotherwhid.trim();
	}
	...
	public void setCoutwarehouseid(String coutwarehouseid) {
		this.coutwarehouseid = coutwarehouseid == null ? null : coutwarehouseid.trim();
	}
	...
	public String getCotherbizid() {
		return cotherbizid;
	}

	public void setCotherbizid(String cotherbizid) {
		this.cotherbizid = cotherbizid == null ? null : cotherbizid.trim();
	}
