...
public class CurrtypeVO {
    ...
    private BigDecimal unitcurrdigit;
    ...
    public BigDecimal getUnitcurrdigit() {
        return unitcurrdigit;
    }

    public void setUnitcurrdigit(BigDecimal unitcurrdigit) {
        this.unitcurrdigit = unitcurrdigit;
    }
}